...
/*sophia.collide(wall0);
sophia.collide(wall1);
sophia.collide(wall2);
sophia.collide(wall3);
sophia.collide(wall4);
sophia.collide(wall5);
sophia.collide(wall6);
sophia.collide(wall7);
sophia.collide(wall8);
sophia.collide(wall9);
sophia.collide(wall10);
sophia.collide(wall11);
sophia.collide(wall12);
sophia.collide(wall13);
sophia.collide(wall14);
sophia.collide(wall15);
sophia.collide(wall16);
sophia.collide(wall17);
sophia.collide(wall18);
sophia.collide(wall19);
sophia.collide(wall20);
sophia.collide(wall21);
sophia.collide(wall22);
sophia.collide(wall23);
sophia.collide(wall24);
sophia.collide(wall25);*/
...
fill("yellow");
text("reach to the key to open the treasure", 380,50);

fill("pink");
text("Hint: don't touch the black walls....", 380,80);
